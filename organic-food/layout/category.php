              ...
              <form action="category.php" method="POST">
                <div class="row">
                  <div class="col-lg-10">
                    ...
                    ?>    
                        <option value="" class="button-style"> Choose Category Name</option>
                        <option class="button-style" value="<?php echo $row['cate_name'];?>"><?php echo $row['cate_name'];?></option>
                    <?php
                      }
                    ?>          
                </select>
                  ...
                  <div class="col-lg-2">
                  	<input type="hidden" name="choose_cate_btn" value="<?php echo $row['cate_name']; ?>">
                    <button type="submit" class="btn button-style" name="search">Search</button>
                  </div>
                </div>
