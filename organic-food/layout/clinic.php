                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-lg-8">
                            <h3>Benefits Of : <?php echo $row['cate_name']; ?></h3>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-lg-4">
            ...
            <div class="col-lg-12">       
               <div class="form-group">
                  <form action="clinic.php" method="POST">
                     <div class="row">
                        <div class="col-lg-9">
                           <select name="choose_cate_btn" class="form-control button-style" required="">
                             <?php 
                                 foreach($query_run as $row){
                             ?>    
...
<!-- Button trigger modal -->
                            <button type="submit" class="btn button-style" name="search" data-toggle="modal" data-target="#adminprofile">
                              The Cure
                            </button>
                        </div>
                     </div> 
