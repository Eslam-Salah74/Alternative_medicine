    ...
    <div class="modal-content">
      ...
      <form action="code.php" method='POST' enctype= "multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name='gallery_description' placeholder="Enter Gallery Description" required="">
            </div>
            <div class="form-group">
            ...
            <!-- Start Featch Data From Databas -->
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    ?>
                        ...
                        <td><?php echo '<img src="upload/home/gallery/'.$row["image"].'" width="40px"; height="40px" class="img-fluid" alt="Responsive image">'  ?></td>
                        <td>
